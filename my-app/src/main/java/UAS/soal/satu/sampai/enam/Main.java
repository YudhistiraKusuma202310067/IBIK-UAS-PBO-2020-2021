...
class Users{
	private Long NIK; //Mengubah tipe data NIK dari Integer ke Long karena nilainya berada di luar kapasitas rentang tipe data Integer
	private String Fullname;
	private String Address;
	
	public Long getNIK() { //Mengubah tipe data NIK dari Integer ke Long karena nilainya berada di luar kapasitas rentang tipe data Integer
		return NIK;
	}
	public void setNIK(Long nIK) { //Mengubah tipe data NIK dari Integer ke Long karena nilainya berada di luar kapasitas rentang tipe data Integer
		NIK = nIK;
	}
...
class Profile extends Users{
	...
	//Menambahkan setter untuk attribute Avatar
...
public class Main extends JFrame{
	private Long NIK = 3202310072L; //Mengubah tipe data NIK dari Integer ke Long karena nilainya berada di luar kapasitas rentang tipe data Integer
